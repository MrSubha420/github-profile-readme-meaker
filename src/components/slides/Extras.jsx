...
`;
    ...
    if (document.getElementById("visitorschk").checked === true) {
      extras =
        ...
        `
---
![](https://visitcount.itsvg.in/api?id=${gprmStore.data.username}&icon=${icon}&color=${color})
`;
    }
...
`;
  ...
  `;
    ...
    finaldata = `${finaldata}
<!-- Proudly created with AGPG ( https://agpg.netlify.app ) -->`;
      ...
      {isVisible ? (
        ...
        <div className="flex flex-col items-center fade-on-appear">
          ...
          <a href="https://visitcount.itsvg.in" className="">
            <img
              id="visitors"
              src={`https://visitcount.itsvg.in/api?id=MrSubha420&pretty=true&icon=${icon}&color=${color}`}
              alt=""
              className="mb-4"
            />
          </a>
