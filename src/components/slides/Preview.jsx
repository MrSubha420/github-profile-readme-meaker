...
import MarkdownIt from "markdown-it";  // Import instead of require

import { observer } from "mobx-react-lite";  // Wrap with observer
...
export default observer(Preview); // Wrap with observer
